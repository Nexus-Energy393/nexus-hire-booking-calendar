...
const F = {
  ...
  // --- electrical-install fields (map a real hash via the PD_FIELD_* env var; ---
  // --- until then the deal returns no value and the jobsheet shows a fillable line) ---
...
/* Read a field as a resolved enum label, or its raw text value, else "". */
